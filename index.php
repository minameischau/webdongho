                ...
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        ...
                        <div class="header-right">
                            <ul id="navigation">  
                                <li><a class="nav-log" style="font-size: 16px; font-family: Josefin Sans,sans-serif; color: #141517; font-weight: 600;"  href="./register.php">Đăng ký</a></li>
                                <li><a class="nav-log" style="margin-left:18px; font-size: 16px; font-family: Josefin Sans,sans-serif; color: #141517; font-weight: 600;" href="./login.php">Đăng nhập</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
